...
const title = 'Matias Gomez';
const descripcion = 'Estudiante Universitario en Programación - UTN';
const residencia = 'San Martin, Mendoza, Argentina';
const presentacion = 'Hola, Bienvenido a mi portafolio de proyectos. Soy estudiante de la facultad regional UTN San Rafael - Mendoza';
const redesSociales = [
